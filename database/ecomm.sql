...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2019 at 05:45 PM
...
CREATE TABLE `products` (
  ...
  `review` longtext CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `sales` (
  ...
  `cmt` longtext CHARACTER SET utf8 COLLATE utf8_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sales` (`id`, `user_id`, `pay_id`, `sales_date`, `cmt`) VALUES
...
(1, 'admin@admin.com', '$2y$10$.cCviKGEn6hZZB5DnSzq/O565N2nhNw7bg02uSJReNvWsgVOAbboy', 1, 'Khoi', 'Le', '', '', 'admin.png', 1, '', '', '2018-05-01'),
